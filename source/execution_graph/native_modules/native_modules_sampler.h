...
namespace sampler_native_modules wl_library(k_sampler_library_id, "sampler", 0) {
	...
	wl_runtime_only
	void sampler(
		wl_in wl_const const c_native_module_string &name,
		wl_in wl_const real32 channel,
		wl_in real32 speed,
	...
	void sampler_wavetable(
		wl_in wl_const const c_native_module_real_array &harmonic_weights,
