...
static void split_fractional_sample_index(real64 sample_index, uint32 &out_int, real32 &out_fraction);
...
static void split_fractional_sample_index(real64 sample_index, uint32 &out_int, real32 &out_fraction) {
	...
	out_int = static_cast<uint32>(sample_index);
	out_fraction = static_cast<real32>(sample_index - static_cast<real64>(out_int));
}
