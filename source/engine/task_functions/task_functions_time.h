#ifndef WAVELANG_ENGINE_TASK_FUNCTIONS_TASK_FUNCTIONS_TIME_H__
#define WAVELANG_ENGINE_TASK_FUNCTIONS_TASK_FUNCTIONS_TIME_H__
...
#endif // WAVELANG_ENGINE_TASK_FUNCTIONS_TASK_FUNCTIONS_TIME_H__
