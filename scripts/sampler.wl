...
module real sampler_sin(in real frequency) {
	real[] frequency_weights := json.read_real_array("common_waveforms.json", "sine");
...
module real sampler_sawtooth_phase(in real frequency, in real phase) {
	real[] frequency_weights := json.read_real_array("common_waveforms.json", "sawtooth");
...
module real sampler_triangle(in real frequency) {
	real[] frequency_weights := json.read_real_array("common_waveforms.json", "triangle");
	return sampler.sampler_wavetable(frequency_weights, frequency, 0);
}
